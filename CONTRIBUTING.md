...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("openair-project/openair", fork = TRUE)`.
...
- Care should be taken such that new code follows a style similar to the
  rest of [openair](https://openair-project.github.io/openair/). The
  most user-facing example of this is that exported functions should be
  written in “lowerCamelCase” (i.e.,
...
Conduct](https://openair-project.github.io/openair/CODE_OF_CONDUCT.md).
