...
#'   `"default"`. This option makes sweeping changes to non-data plot features
...
#'   [ggplot2::theme()] object, which will be used to modify the `"default"`
...
#'
#'   - `"dark"`, a dark-background variant of the default theme, designed for
