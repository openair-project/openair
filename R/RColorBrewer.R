...
# where entry [[k]] gives the RGB matrix for n = k + 2 colours.
# ---------------------------------------------------------------------------
.brewer_data <- list(
  Accent = list(
    rgb(
  ...
  Dark2 = list(
    rgb(c(27, 217, 117), c(158, 95, 112), c(119, 2, 179), maxColorValue = 255),
    rgb(
      c(27, 217, 117, 231),
      c(158, 95, 112, 41),
      c(119, 2, 179, 138),
  ...
  Greys = list(
    rgb(c(240, 189, 99), c(240, 189, 99), c(240, 189, 99), maxColorValue = 255),
    rgb(
      c(247, 204, 150, 82),
      c(247, 204, 150, 82),
      c(247, 204, 150, 82),
  ...
  Set1 = list(
    rgb(c(228, 55, 77), c(26, 126, 175), c(28, 184, 74), maxColorValue = 255),
    rgb(
      c(228, 55, 77, 152),
      c(26, 126, 175, 78),
      c(28, 184, 74, 163),
  ...
  YlOrBr = list(
    rgb(c(255, 254, 217), c(247, 196, 95), c(188, 79, 14), maxColorValue = 255),
    rgb(
      c(255, 254, 254, 204),
      c(255, 217, 153, 76),
      c(212, 142, 41, 2),
  ...
  YlOrRd = list(
    rgb(c(255, 254, 240), c(237, 178, 59), c(160, 76, 32), maxColorValue = 255),
    rgb(
      c(255, 254, 253, 227),
      c(255, 204, 141, 26),
      c(178, 92, 60, 28),
...
brewer.pal <- function(n, name, direction = 1, alpha = 1, begin = 0, end = 1) {
  ...
  cols <- .brewer_data[[name]][[n - 2L]]

  # begin/end: subset the input colours then interpolate back to n
  if (is_seq && (begin != 0 || end != 1)) {
    indices <- round(1 + (length(cols) - 1) * c(begin, end))
